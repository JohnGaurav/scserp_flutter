...
class _SubjectScreenState extends State<SubjectScreen> {
  ...
  Future<void> apiData() async {
    ...
    subjectList = decoded["data"];

    setState(() {
      _source = MyDataSource(List<Map<String, dynamic>>.from(subjectList));
      _loading = false;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Subjects'), elevation: 5.0),
                    ...
                    child: SizedBox(
                      ...
                      child: PaginatedDataTable2(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Text('Program Objective')),
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow.byIndex(
      ...
      cells: [
        ...
        DataCell(
          ElevatedButton(
            onPressed: () => print("View 1: ${apijson['id']}"),
            child: const Text('View'),
          ),
        ),
        DataCell(
          ElevatedButton(
            onPressed: () => print("View 2: ${apijson['id']}"),
            child: const Text('View'),
          ),
        ),
      ],
