...
class DeaneryMasterScreen extends StatefulWidget {
  const DeaneryMasterScreen({super.key});

  @override
  State<DeaneryMasterScreen> createState() => _DeaneryMasterScreenState();
}

class _DeaneryMasterScreenState extends State<DeaneryMasterScreen>
