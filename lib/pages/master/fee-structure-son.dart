...
class FeeStructureSonScreen extends StatefulWidget {
  const FeeStructureSonScreen({super.key});

  @override
  State<FeeStructureSonScreen> createState() => _FeeStructureSonScreenState();
}

class _FeeStructureSonScreenState extends State<FeeStructureSonScreen>
        ...
        children: [
          ...
          BootstrapRow(
            ...
            children: [
              ...
              BootstrapCol(
                sizes: 'col-12 col-md-6 col-lg-4 col-xl-4 col-sm-12',
                child: deaneryCard('Department of Commerce', Colors.redAccent),
              ),
              BootstrapCol(
                sizes: 'col-12 col-md-6 col-lg-4 col-xl-4 col-sm-12',
                child: deaneryCard('Department of Science', Colors.deepPurple),
              ),
            ],
          ),
        ],
