...
class UGApplicationScreen extends StatefulWidget {
  const UGApplicationScreen({super.key});

  @override
  State<UGApplicationScreen> createState() => _UGApplicationScreenState();
}

class _UGApplicationScreenState extends State<UGApplicationScreen> {
  ...
  Future<void> apiData({int page = 1, bool append = false}) async {
    ...
    http.Response apiResponse = await http.get(
      Uri.parse("$baseUrl/ug-applications?page=$page"),
